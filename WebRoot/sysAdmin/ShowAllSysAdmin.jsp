								...
								<div class="box span10 oh">
									<table width="100%" border="0" cellpadding="0" cellspacing="0"
										...
										<%
											...
											%>
										<tr class="tr">
											<td class="td_center"><%=admin[0]%></td>
											<td class="td_center"><%=admin[1]%></td>
											<td class="td_center"><%=admin[3]%></td>
											<td class="td_center"><%=admin[4]%></td>
											<td class="td_center"><%=admin[5]%></td>
