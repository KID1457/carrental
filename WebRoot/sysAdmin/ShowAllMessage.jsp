			...
			<table border="0" cellpadding="0" cellspacing="0" class="list_table">
				...
				<tr class="tr">
					<td class="td_center"><input name="" type="image"
						...
						src="<%=basePath%>uploadFiles/<%=message[4]%>" /></td>
					<td class="">
						<p style="margin-left: 5px; margin-right: 5px;">
							<%=message[2]%>
						</p>
						<p style="margin: 5px; padding-top: 5px;">
							Message Sharing Time：<%=message[3].substring(0,19)%>
						</p>
					</td>
					<td class="td_center">
						<%if(message[5].equals("0")){
						%> To be audited <%}else if(message[5].equals("1")){%> Pass <%}else if(message[5].equals("2")){%>
						Not Pass <%}%>
					</td>
					<td class="td_center">
						<form
