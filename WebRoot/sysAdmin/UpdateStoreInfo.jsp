...
<body>
							...
							<tbody>
								<tr>
									...
									<td class=""><input type="hidden" name="id" id="id"
										value=" <%=store.getStoreId()%>" /> <input type="text"
										name="no" id="no" class="input-text lh30" size="40"
										value="<%=store.getStoreNo()%>"></td>
								</tr>
								<tr>
									<td class="td_right">Pasword：</td>
									<td><input type="password" name="password" id="password"
										class="input-text lh30" size="40"
										value="<%=store.getStorePassword()%>"></td>
								</tr>
								<tr>
									<td class="td_right">Name：</td>
									<td><input type="text" name="name" id="name"
										class="input-text lh30" size="40"
										value="<%=store.getStoreName()%>"></td>
								</tr>
								<tr>
									<td class="td_right">Phone：</td>
									<td><input type="text" name="phone" id="phone"
										class="input-text lh30" size="40"
										value="<%=store.getStorePhone()%>"></td>
								</tr>
								<tr>
									<td class="td_right">City：</td>
									<td class="">
	...
	$("#city").click( function(e) {
		SelCity(this, e);
								...
								<tr>
									<td class="td_right">Photo：</td>
									<td class=""><img id="image1"
										src="<%=basePath%>uploadFiles/<%=store.getStoreImage()%>"
										width="180" height="140" /> <input type="hidden"
										name="oldImg" value="<%=store.getStoreImage()%>" /></td>
								</tr>

								<tr>
									<td class="td_right">Upload：</td>
