			...
			<div class="box">
				<div class="box_border">
					<form
						...
						method="post">
						<div class="box_top">
							<b class="pl15">Admins</b> <input type="submit" name="button"
								style="float: right;" class="btn btn82 btn_config" value="save">
							<input type="button" name="button" style="float: right;"
								class="btn btn82 btn_add" value="add"
								onclick="addSysAdminInfo()"> <input type="button"
								name="button" style="float: right;" class="btn btn82 btn_search"
								value="view" onclick="ShowAllSysAdmin()">
						</div>
							...
							<table class="form_table pt15 pb15" width="100%" border="0"
								...
								<tr>
									...
									<td class=""><input type="text" name="no" id="no"
										class="input-text lh30" size="40" value="<%=admin.getSNo()%>">
									</td>
								</tr>
								<tr>
									<td class="td_right">Password：</td>
									<td class=""><input type="password" name="password"
										id="password" class="input-text lh30" size="40"
										value="<%=admin.getSPassword()%>"></td>
								</tr>
								<tr>
									<td class="td_right">Name：</td>
									<td class=""><input type="text" name="name" id="name"
										class="input-text lh30" size="40"
										value="<%=admin.getSName()%>"></td>
								</tr>
								<tr>
									<td class="td_right">Phone：</td>
									<td class=""><input type="text" name="phone" id="phone"
										class="input-text lh30" size="40"
										value="<%=admin.getSPhone()%>">
								</tr>
								<tr>
									<td class="td_right">Address：</td>
									<td class=""><textarea name="address" id="address"
											id="address" cols="30" rows="10" class="textarea"><%=admin.getSAddress()%></textarea>
									</td>
								</tr>
