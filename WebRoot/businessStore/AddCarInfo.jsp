			...
			<div class="box">
				<form action="<%=basePath%>servlet/CarServlet?method=addCarInfo"
					...
					<div class="box_border">
						<div class="box_top">
							<b class="pl15">Add Car Info</b> <input style="float: right;"
							...
							<table width="1500" border="0"
								...
								<tr>
									<td colspan="2" rowspan="5"><img name="img"
										...
										onchange="previewImg(this.value);"></td>
								...
								<tr>
									<td width="80" height="46" align="left"><strong>carMoney</strong>
									</td>
