				...
				<div class="col-main">
					...
					<div class="order-status status-orange">
						...
						<p>
							...
							<span> | </span>Payment method：online <span>|</span>status：<%=orderMap.get("orderState")%>
						</p>
					</div>
...
if(shangMenQuCheAddress.length()!=0){
 %>
							...
							<div class="price-info-item">
								<div class="price-info-item-hd">
									<h3>
										remark： <span class="insurance-count"> <span
							...
							<div class="price-info-total">
								<span class="txt">total sum：</span> <sup class="ui-rmb"> ¥
								</sup>
						...
						<div class="prepay-tips">
							...
							<p>Thank you very much for your reservation. Have a safe
								journey</p>
					...
					<div class="order-operate">
						<a id="btn-cancel" class="ui-btn ui-btn-white-l btn-cancel"
							href="<%=basePath%>servlet/OrderServlet?method=returnCar&orderId=<%=orderMap.get("orderId")%>&carId=<%=carMap.get("carId")%>"><span>Return
								operation</span> </a>
