		...
		<div id="forms" class="mt10">
			<div class="box">
				<div class="box_border">
					<div class="box_top">
						<b class="pl15">Business Store Info</b>
					</div>
					<center>
						<div class="box_center">
							...
							<table width="800" border="0" style="margin-bottom: 100px;">
								<tr>
									<td width="320" rowspan="6"><img name=""
										src="<%=basePath%>uploadFiles/<%=store.getStoreImage()%>"
										width="300px" height="250px" /> &nbsp;</td>
									<td width="138" height="50"><strong>Account：</strong></td>
									<td width="328" height="50"><%=store.getStoreNo()%></td>
								</tr>
								<tr>
									<td height="50"><strong>Store Name：</strong></td>
									<td height="50"><%=store.getStoreName()%></td>
								</tr>
								<tr>
									<td height="50"><strong>Tel：</strong></td>
									<td height="50"><%=store.getStorePhone()%></td>
								</tr>
								<tr>
									<td height="50"><strong>City：</strong></td>
									<td height="50"><%=store.getStoreProvince()%> <%=store.getStoreCity()%>
										<%=store.getStoreDistrict()%></td>
								</tr>
								<tr>
									<td height="50"><strong>Address：</strong></td>
									<td height="50"><%=store.getStoreAddress()%></td>
								</tr>
