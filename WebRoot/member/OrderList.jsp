				...
				<div class="col-main">
					<div class="mod J_TabSwitch order-list self-order">
						<div class="hd clearfix">
							<h2>Self driving order</h2>
							<ul class="ui-tab-hd">
								<li class="ck"><a class="orderTab"
									href="javascript:void(0)">All</a></li>
								<li class=""><a class="orderTab" href="javascript:void(0)">To
										be paid</a></li>
								<li class=""><a class="orderTab" href="javascript:void(0)">Waiting
										for departure</a></li>
								<li class=""><a class="orderTab" href="javascript:void(0)">Leasing</a>
								</li>
								<li><a class="orderTab" href="javascript:void(0)">Waiting
										for return</a></li>
								<li><a class="orderTab" href="javascript:void(0)">Finish
										orders</a></li>
								<li><a class="orderTab" href="javascript:void(0)">Cancel</a>
								</li>
							</ul>
						</div>
						<div class="bd">
							...
							<div class="ui-tab-bd">
								<div class="ui-table-list all" style="display: block;">
									<table width="100%">
										<tbody>
											<tr>
												<th class="row-first-cell" width="12%"
													style="font-size: 20px;">order num</th>
												<th width="20%" style="font-size: 20px;">type</th>
												<th width="10%" style="font-size: 20px;">carMoney</th>
												<th width="10%" style="font-size: 20px;">total sum</th>
												<th width="18%" style="font-size: 20px;">picking time</th>
												<th width="18%" style="font-size: 20px;">return time</th>
												<th width="14%" style="font-size: 20px;">status</th>
											</tr>
											<%
											...
											<tr>
												<td class="row-first-cell" style="font-size: 20px;"><a
													href="<%=basePath %>servlet/OrderServlet?method=orderDetail&orderId=<%=order[0]%>&carId=<%=order[4]%>"><%=order[0]%></a>
													<br></td>
												...
												<td style="font-size: 15px;"><font color="#ff8000">
														<strong>¥<%=order[8]%></strong>
												</font> <br></td>
												<td style="font-size: 15px;"><font color="#ff8000">
														<strong>¥<%=order[9]%></strong>
												</font></td>

												<td style="font-size: 15px;"><%=order[6].substring(0, 19)%>
												</td>
												<td style="font-size: 15px;"><%=order[7].substring(0, 19)%>
												</td>
												<td style="font-size: 15px;"><span class="orange"><%=order[10]%></span>
												</td>
											</tr>
											<%
													}
								...
								<div class="ui-table-list reserving" style="display: none;">
									<table width="100%">
										<tbody>
											<tr>
											...
											<tr>
												<td class="row-first-cell" style="font-size: 20px;"><a
													href="<%=basePath %>servlet/OrderServlet?method=orderDetail&orderId=<%=order[0]%>&carId=<%=4%>"><%=order[0]%></a>
													<br></td>
												<td style="font-size: 15px;">
													<%
															ICarDAO carDAO = new CarDAO();
								...
								<div class="ui-table-list complete" style="display: none;">
									<table width="100%">
										<tbody>
											<tr>
												<th class="row-first-cell" width="12%"
								...
								<div class="ui-table-list canceled" style="display: none;">
									<table width="100%">
										<tbody>
											<tr>
												<th class="row-first-cell" width="12%"
								...
								<div class="ui-table-list pending" style="display: none;">
									<table width="100%">
										<tbody>
											<tr>
												<th class="row-first-cell" width="12%"
