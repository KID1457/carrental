	...
	<div style="width: 1100px;">
		<div class="payment-wrap">
			...
			<div class="payment-info-box" style="width: 1100px;">
				...
				<div id="divOrderInfo" class="payment-detail">
					<span class="pay-order">订单号:<%=orderMap.get("orderId")%></span> <span
						class="pay-type">支付方式:网上支付</span> <span class="pay-price">订单总价:<em>￥<%=orderMap.get("totalMoney")%></em>(只接受银行卡支付，不接受现金）
					</span>
				</div>
		...
		<div class="pay-online-wrap" style="width: 1100px;">
			<div class="pay-online-tabbox">
				<div class="pay-online-title">选择付款方式</div>
				<div class="pay-online-tab tab-wyzf active">网银支付</div>
			</div>
