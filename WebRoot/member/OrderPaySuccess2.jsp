	...
	<div class="payment-wrap">
		...
		<div class="payment-info-box" style="width: 1100px;">
			<div class="payment-info">
				...
				<div class="pay-help">
					取车时请务必携带本人 <span>有效身份证、驾照正副本、本人信用卡</span>
				</div>
			</div>
			<%
			...
			<div id="divOrderInfo" class="payment-detail">
				...
				<span class="pay-type">支付方式:网上支付</span> <span class="pay-price">订单总价:<em>￥<%=orderMap.get("totalMoney")%></em>(只接受银行卡支付，不接受现金）
				</span>
			</div>
			<div class="payment-remark highlight no-margin">
				<p>请在规定时间内到本营业门店取车，否则订单将自动取消。</p>
			</div>
			<div class="payment-link">
				<a href="<%=basePath %>member/welcome.jsp" title="返回首页">返回首页</a> <a
					href="<%=basePath %>member/memberInfoCenter.jsp" title="查看订单">查看订单</a>
			</div>
		</div>
