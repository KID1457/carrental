									...
									<tbody>
										<tr>
											...
											<td>&nbsp;&nbsp;&nbsp; <input type="submit"
												name="button" class="btn btn82 btn_search" value="select">
											</td>
										</tr>
									</tbody>
								</table>
								...
								<div class="box span10 oh">
									<table width="100%" border="0" cellpadding="0" cellspacing="0"
										...
										<%
											 ...
											 %>
										<tr class="tr">
											<td class="td_center"><%=dayRegister[0] %></td>
											<td class="td_center"><%=dayRegister[1] %></td>
											<td class="td_center"><%=dayRegister[2] %></td>
											<td class="td_center"><%=dayRegister[3] %></td>
											<td class="td_center"><%=dayRegister[4] %></td>
											<%}} %>
