		...
		<div id="forms" class="mt10">
			<div class="box">
				<div class="box_border">
					<div class="box_top">
						<b class="pl15">Business Statistics</b>
					</div>
					<center>
						<form
								...
								<div class="box span10 oh">
									<table width="100%" border="0" cellpadding="0" cellspacing="0"
										...
										<tr class="tr">
											...
											<td class="td_center"><%=storeProfit[2] %></td>
											<td class="td_center"><%=storeProfit[3] %></td>
											<td class="td_center"><%=storeProfit[4] %></td>
											<td class="td_center"><%=storeProfit[5] %></td>
											<%}} %>
