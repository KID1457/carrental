...
public class OrderDAO implements IOrderDAO {
	...
	public ArrayList<String[]> searchTimeOutOrder(String nowDate) {
		...
		String sql = "select * from t_order where t_order.orderState='To be paid' AND "
	...
	public ArrayList<String[]> searchDaiChuCheTimeOutOrder() {
		...
		String sql = " SELECT * " + " FROM t_order "
				+ " WHERE t_order.orderState='Waiting for departure' AND "
				+ " collectionTime < NOW() ";
	...
	public ArrayList<String[]> searchDaiHuanCheOrderByToStoreId(int toStoreId,
		...
		String sql = "SELECT * from t_order where toStoreId=" + toStoreId
				+ " and orderState='Waiting for return'" + "limit " + (start - 1) + ","
				+ pageSize;
	...
	public Object[] getRsCountDaiHuanCheOrderByToStoreId(int toStoreId) {
		...
		String sql = "SELECT count(*) from t_order where toStoreId="
				+ toStoreId + " and orderState='Waiting for return'";
	...
	public Object[] getRsCountStoreAllOrder(int storeId) {
		...
		String sql = " SELECT " + " 	count(*) " + " FROM " + " 	t_order "
				...
				+ " 		AND ( " + " 			orderState = 'To be paid' "
				+ " 			OR orderState = 'Waiting for departure' " + " 			OR orderState = 'Leasing' "
				+ " 			OR orderState = 'Finish orders' " + " 			OR orderState = 'Cancel' "
				+ " 		) " + " 	) " + " OR ( " + " 	toStoreId =" + storeId
				+ " 	AND orderState = 'Waiting for return' " + " ) " + " ORDER BY "
				+ " 	orderTime DESC ";
	...
	public ArrayList<String[]> searchStoreAllOrder(int storeId, int pageSize,
		...
		String sql = " SELECT " + " 	* " + " FROM " + " 	t_order " + " WHERE "
				...
				+ " 			orderState = 'To be paid' " + " 			OR orderState = 'Waiting for departure' "
				+ " 			OR orderState = 'Leasing' " + " 			OR orderState = 'Finish orders' "
				+ " 			OR orderState = 'Cancel' " + " 		) " + " 	) " + " OR ( "
				+ " 	toStoreId =" + storeId + " 	AND orderState = 'Waiting for return' "
	...
	public Object[] getRsCountCanReturnCar(int storeId) {
		...
		String sql = " SELECT " + " count(*) " + " FROM " + "	t_order "
				...
				+ "	t_order.orderState = 'Leasing' "
				+ "	OR t_order.orderState = 'Waiting for return' " + " ) ";
	...
	public ArrayList<String[]> searchCanReturnCar(int storeId, int pageSize,
		...
		String sql = " SELECT " + "  * " + " FROM " + "	t_order " + " WHERE "
				...
				+ "	t_order.orderState = 'Leasing' "
				+ "	OR t_order.orderState = 'Waiting for return' " + " ) " + " limit "
				+ (start - 1) + "," + pageSize;
	...
	public ArrayList<String[]> getDayStoreProfit(String date) {
		...
		String sql=" SELECT "+
				...
				" 			    OR t_order.orderState = 'Leasing' "+
				" 			    OR t_order.orderState = 'Waiting for return' "+
				" 			    OR t_order.orderState = 'Finish orders' "+
				" 			    OR ( "+
				" 				    t_order.orderState = 'Cancel' "+
	...
	public Object[] getAllOrderByConditionRsCount(String orderId,
		...
		//If no start time or end time is selected
...
//					" limit "+ (start - 1) + "," + pageSize;
	...
	public Object[] getCanReturnOrderRsCount(int storeId, String orderId,
		...
		String sql=" SELECT count(*) from t_order "+ 
				...
				" ( "+
				" t_order.orderState='Leasing' OR "+
				" t_order.orderState='Waiting for return' "+
